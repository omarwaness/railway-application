...
const routes = app
    ...
    .get("/", sValidator("query", listDeploymentsSchema), async (c) => {
    ...
    .post("/", sValidator("json", deploySchema), async (c) => {
        const client = createRailwayClient(c.get("railwayToken"));
    ...
    .post("/redeploy", sValidator("json", serviceEnvSchema), async (c) => {
        const client = createRailwayClient(c.get("railwayToken"));
    ...
    .post("/triggers", sValidator("json", triggersDeploySchema), async (c) => {
        const client = createRailwayClient(c.get("railwayToken"));
    ...
    .post("/:id/redeploy", sValidator("param", idParamSchema), async (c) => {
        const client = createRailwayClient(c.get("railwayToken"));
        const { id } = c.req.valid("param");
    ...
    .post("/:id/restart", sValidator("param", idParamSchema), async (c) => {
        const client = createRailwayClient(c.get("railwayToken"));
        const { id } = c.req.valid("param");
    ...
    .post("/:id/rollback", sValidator("param", idParamSchema), async (c) => {
        const client = createRailwayClient(c.get("railwayToken"));
        const { id } = c.req.valid("param");
    ...
    .post("/:id/stop", sValidator("param", idParamSchema), async (c) => {
        const client = createRailwayClient(c.get("railwayToken"));
        const { id } = c.req.valid("param");
    ...
    .post("/:id/cancel", sValidator("param", idParamSchema), async (c) => {
        const client = createRailwayClient(c.get("railwayToken"));
        const { id } = c.req.valid("param");
