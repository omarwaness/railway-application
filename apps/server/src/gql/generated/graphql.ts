...
export type ProjectsQuery = { projects: { edges: Array<{ node: { id: string, name: string, description: string | null, createdAt: string, updatedAt: string, deletedAt: string | null, isPublic: boolean, workspaceId: string | null, primaryEnvironmentId: string | null, services: { edges: Array<{ node: { id: string, name: string, icon: string | null, deletedAt: string | null } }> } } }>, pageInfo: { hasNextPage: boolean, endCursor: string | null } }, apiToken: { workspaces: Array<{ id: string, name: string }> } };
...
export type ProjectOverviewQuery = { project: { id: string, name: string, description: string | null, createdAt: string, updatedAt: string, deletedAt: string | null, isPublic: boolean, workspaceId: string | null, primaryEnvironmentId: string | null, environments: { edges: Array<{ node: { id: string, name: string, isEphemeral: boolean, createdAt: string, unmergedChangesCount: number | null, serviceInstances: { edges: Array<{ node: { ' $fragmentRefs'?: { 'ServiceRowFragment': ServiceRowFragment } } }> } } }>, pageInfo: { hasNextPage: boolean, endCursor: string | null } } } };
...
export type ProjectCreateMutation = { projectCreate: { id: string, name: string, description: string | null, createdAt: string, updatedAt: string, deletedAt: string | null, isPublic: boolean, workspaceId: string | null, primaryEnvironmentId: string | null } };
...
export type ProjectUpdateMutation = { projectUpdate: { id: string, name: string, description: string | null, updatedAt: string, isPublic: boolean, prDeploys: boolean, botPrEnvironments: boolean, focusedPrEnvironments: boolean, primaryEnvironmentId: string | null, baseEnvironmentId: string | null } };
